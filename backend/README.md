...
## Project Structure
    ...
    ├── test_rn_qr_code_dev_82683  # Django project configurations
...
1. Clone this repo and `cd test_rn_qr_code_dev_82683`
...
2. Clone this repo and `cd test_rn_qr_code_dev_82683`
